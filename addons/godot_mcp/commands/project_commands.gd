...
func _get_project_info(client_id: int, _params: Dictionary, command_id: String) -> void:
	...
	var project_version = ProjectSettings.get_setting("application/config/version", "1.1.0")
...
func _get_project_settings(client_id: int, params: Dictionary, command_id: String) -> void:
	...
	var settings = {
		...
		"project_version": ProjectSettings.get_setting("application/config/version", "1.1.0"),
		"display": {
